...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		int quantity=getTokens("[A-Za-z]+").size();
	    return quantity;
	}
	...
	public int getNumSyllables()
	{
		...
		for (String word : words) {
			numOfSyllabes+=countSyllables(word);
		}
        return numOfSyllabes;
	}
...
//		BasicDocument obj=new BasicDocument("This is a test.  How many???  "
//   	        + "Senteeeeeeeeeences are here... there should be 5!  Right?");
//		System.out.println(obj.getNumWords());
//		System.out.println(obj.getNumSentences());
//		System.out.println(obj.getNumSyllables());
//		System.out.println(obj.getFleschScore());
		
		BasicDocument obj=new BasicDocument("hello spliitting in split");
		List<String> lista=obj.getTokens("[^it ]+");
		System.out.println(lista.toString());
		lista=obj.getTokens("it");
		System.out.println(lista.toString());
		lista=obj.getTokens("i+t+");
		System.out.println(lista.toString());
		lista=obj.getTokens("[it]*");
		System.out.println(lista.toString());
		
//		BasicDocument obj=new BasicDocument("123arroz123arroz456carne789atun");
//		List<String> lista=obj.getTokens("[0-9]+");
//		List<String> lista2=obj.getTokens("[a-z]+");
//		System.out.println(lista.toString());
