...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
		...
		List<String> syllabes = getTokensByText("[aeiouAEIOUyY]+",word);
		int quantity=syllabes.size();
		char lastLetter = word.charAt(word.length()-1);
		
		if((lastLetter=='E' || lastLetter=='e') && quantity > 1)
			quantity--;
	...
	public double getFleschScore()
	{
		...
		double ASL=getNumWords()/getNumSentences();
		double ASW=getNumSyllables()/getNumWords();
